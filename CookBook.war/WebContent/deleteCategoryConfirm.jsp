...
<div align="center">
	...
	<div class="main">		
		<div class="subcontainer">			
			<span class="head_line"> Удаление группы "<c:out value="${presentation.currentCategoryName}"/>"</span>
			<br /><br />
			Вы действительно хотите удалить группу? <br/>
			<form method="post" action="CookBooFormHandler">		
				<input type="hidden" name="action" value="delete_cat_sure" /> 
