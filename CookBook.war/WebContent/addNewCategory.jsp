...
<div align="center">
	...
	<div class="main">		
		<div class="subcontainer">			
			<span class="head_line"> Создание новой группы </span>
			<br /><br />
			<form method="post" action="CookBooFormHandler">		
				<input type="hidden" name="action" value="add_new_category" /> 
				Имя группы: <br />
				<input type="text" name="newCategoryName" value="" /> <br /><br />
				<input type="submit" value="Добавить" /> <input type="button" value="Отмена" onclick="javascript:window.history.go(-1);" /> 				
			</form>	
		</div>
		<div class="tool_box">
